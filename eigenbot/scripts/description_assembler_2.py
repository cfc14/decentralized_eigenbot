...
def description_assemble(module_ID, module_attachments, module_ID_serials):
  ...
  for module_num in range(len(module_ID)):
      ...
      origin = origins[module_num]
      print(module_num)
      print(origin)
      mod_path = 'description/' + module_name + '.xml'
      tree = ET.parse(os.path.abspath(mod_path))
      #tree = ET.parse(os.path.join('description', module_name + '.xml')
      ...
      M_num_parent = 'M' + str(module_num) + 'S' + str(module_ID_serials[module_num])
      ...
      for attachment in module_attachments[module_num]:
        if len(attachment)>0:
          ...
          # xyz_n = [xyz_n[i] + origin[i] for i in range(3)]
          xyz_n = [xyz_n[i]  for i in range(3)]
          #if len(module_attachments[module_num]) > 1:
          #	origin = origin
          #else:
          #	origin = xyz_n
          origins.append(xyz_n)
          xyz = [str(xyz_n[i]) for i in range(len(xyz))]
          xyz = " ".join(xyz)
          mount_xyz.append(xyz)
          mount_rpy.append(rpy)
          print("attach " + str(child_module) + " on " + str(parent_rigid_body) + " at (" + xyz + '), (' + rpy + ")\n")
  ...
  for module_num in range(len(module_ID)):	
      ...
      M_num = 'M' + str(module_num) + 'S' + str(module_ID_serials[module_num])
...
#  catkin_path = subprocess.check_output(['catkin', 'locate']) # get path of ROS workspace
  ...
  urdf_path = catkin_path +'/src/eigenbot/urdf/'
...
#   module_ID = ['Module_Type_1', 'Module_Type_2', 'Module_Type_1']
#   module_ID_serials = ['', '', '', '', '', '', '', '', '']
#   module_attachments = [
#   [[0, 1, 'Module_Type_2']],
#   [[0, 1, 'Module_Type_1']],
...
#   module_ID = ['Module_Type_2', 'Module_Type_1', 'Module_Type_2']
#   module_ID_serials = ['', '', '', '', '', '', '', '', '']
#   module_attachments = [
#   [[0, 0, 'Module_Type_1'], [0, 1, 'Module_Type_2']],
#   [],
...
#   ] 
  ...
  # module_ID = ['Module_Type_2', 'Module_Type_1', 'Module_Type_1', 'Module_Type_2', 'Module_Type_2', 'Module_Type_1', 'Module_Type_1']
  # module_ID_serials = ['', '', '', '', '', '', '', '', '']
  # module_attachments = [
  #   [[0, 0, 'Module_Type_1'], [0, 1, 'Module_Type_1'], [1, 4, 'Module_Type_1'], [1, 5, 'Module_Type_1']],
  #   [],
...
#   module_ID = ['Module_Type_2', 'Module_Type_1', 'Module_Type_1', 'Module_Type_1', 'Module_Type_1','Module_Type_2','Module_Type_2']
#   module_ID_serials = ['', '', '', '', '', '', '', '', '']
#   module_attachments = [
#   [[0, 0, 'Module_Type_1'], [0, 1, 'Module_Type_1']],
#   [[0, 0, 'Module_Type_1']],
#   [[0, 1, 'Module_Type_1']],
#   [[0, 0, 'Module_Type_2']],
#   [[0, 1, 'Module_Type_2']],
...
#   module_ID = ['Module_Type_2', 'Module_Type_1', 'Module_Type_1', 'Module_Type_1', 'Module_Type_1','Module_Type_2','Module_Type_2', 'Module_Type_1','Module_Type_1']
#   module_ID_serials = ['', '', '', '', '', '', '', '', '']
#   module_attachments = [
#   [[0, 0, 'Module_Type_1'], [0, 1, 'Module_Type_1']],
#   [[0, 0, 'Module_Type_1']],
...
#       'Module_Type_1',
#        'Module_Type_1']
#   module_ID_serials = ['']*len(module_ID)
#   module_attachments = [ 
#    [[0,0, 'Module_Type_1'],
#     [1,0, 'Module_Type_1'],
#     [2,0, 'Module_Type_1'] ,
